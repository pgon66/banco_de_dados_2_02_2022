SELECT
    'Specific select on customer table' AS 'INFO';
...
SELECT
    'Select some specific people' AS 'INFO';
...
SELECT
    'Select some specific people with and that works' AS 'INFO';
...
SELECT
    'Specific selects of films' AS 'INFO';
...
SELECT
    'Introduction To Sub Query' AS 'INFO';
...
SELECT
    'Introduction To Sub Query with variable' AS 'INFO';
